...
func DefaultConfig() Config {
	...
	return Config{
		...
		ASR:     ASRConfig{Provider: "elevenlabs_realtime", APIKeyEnv: "ELEVENLABS_API_KEY", Language: "eng", Secondary: []string{"hin"}, NoVerbatim: true, Model: "scribe_v2_realtime", Endpoint: "wss://api.elevenlabs.io/v1/speech-to-text/realtime"},
