...
func main() {
	...
	case "start", "stop", "toggle", "cancel", "retry-last", "status", "history":
...
func usage() {
	fmt.Fprintln(os.Stderr, "usage: dictationd <init|daemon|start|stop|toggle|cancel|retry-last|retry JOB_ID|status|history>")
}
